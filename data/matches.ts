...
export const MATCHES: MatchData[] = [
  {
    ...
    timeline: [
      ...
      { minute: 34, side: "away", type: "card", card: "yellow", player: "Mokoena", detail: "Mokoena booked for hauling down Son on the break", detailKo: "모코에나, 역습하던 손흥민을 끌어내려 경고" },
      ...
      { minute: 63, side: "home", type: "card", card: "yellow", player: "Hwang In-beom", detail: "Hwang In-beom booked — tactical foul to stop the counter", detailKo: "황인범, 역습을 끊는 전술적 파울로 경고" },
      { minute: 71, side: "away", type: "card", card: "yellow", player: "Sithole", detail: "Sithole booked for time-wasting", detailKo: "시톨레, 지연 행위로 경고" },
