...
const STEPS: Step[] = [
  ...
  {
    target: "tactics",
    titleKo: "⑥ 전술을 바꾸면 즉시 반영됩니다",
    titleEn: "⑥ Tactics apply instantly",
    bodyKo: "공격 성향·수비 라인·압박을 움직이면 선수 배치와 승리 확률이 곧바로 바뀝니다. 여기가 감독의 조작판입니다.",
    bodyEn: "Move Attack, Line, or Press and both the shape and the win probability respond immediately.",
  },
  {
    target: "coach",
